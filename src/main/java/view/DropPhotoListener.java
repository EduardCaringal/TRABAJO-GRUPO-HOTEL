...
public class DropPhotoListener implements DropTargetListener {
    ...
    JDialog jDialog;
    JLabel label;
    String dragText = "<html><center>Deja tu archivo aquí</center><br><center>PHOTO</center><br><center><i>Supported format: PNG.</i></center><br><center><i>Max size 64KB</i></center></html>";
